...
CC_IDENT=gcc 14.2.0 (Alpine 14.2.0)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=-O2 -march=armv8-a -ffile-prefix-map=/work=/usr/src/build -fdebug-prefix-map=/work=/usr/src/build  -O2 -march=armv8-a -ffile-prefix-map=/work=/usr/src/build -fdebug-prefix-map=/work=/usr/src/build -march=armv8-a -std=c17 -fomit-frame-pointer -fPIC -pthread -I/work/prefix/include -I/work/prefix/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=-O2 -march=armv8-a -ffile-prefix-map=/work=/usr/src/build -fdebug-prefix-map=/work=/usr/src/build -O2 -march=armv8-a -ffile-prefix-map=/work=/usr/src/build -fdebug-prefix-map=/work=/usr/src/build -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -O2 -march=armv8-a -ffile-prefix-map=/work=/usr/src/build -fdebug-prefix-map=/work=/usr/src/build -march=armv8-a -fPIC
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=-static -static-libgcc -static-libstdc++ -Wl,--build-id=none -static -static-libgcc -static-libstdc++ -Wl,--build-id=none  -march=armv8-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
HOSTCPPFLAGS= -D_ISOC11_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
HOSTEXESUF=
HOSTLDFLAGS= 
HOSTEXTRALIBS=-lm
DEPHOSTCC=gcc
...
EXTRALIBS-avfilter=-pthread -lm -latomic -L/work/prefix/lib -lzimg -lstdc++
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic
EXTRALIBS-avcodec=-pthread -lm -latomic -L/work/prefix/lib -lx264 -lpthread -lm
...
LDFLAGS-ffprobe += -Wl,-Map,ffprobe_g.map
