...
the runtime archive. It contains the exact FFmpeg, x264, zimg and dav1d 1.5.4 input archives,
...
recipe. The package manifest records the build repository commit. FFmpeg/x264/zimg/dav1d
...
verified Alpine-signed APKs offline. The three directly compiled external media
...
The v1.0.1 candidate also retains dav1d BSD-2-Clause and AV1 patent-license
material, its exact Meson options, Meson/Samurai APK pins and recipe commits,
and the synthetic fixture bytes, generator and provenance manifest. The fixture
authoring encoders are not linked or redistributed; reconstruction uses the
committed, hash-verified media inputs. See V1.0.1-COMPATIBILITY.md.
